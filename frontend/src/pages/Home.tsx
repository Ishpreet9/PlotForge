...
const Home = () => {
  ...
  const generatedIdeas: string[] = [
    "A parallel universe where humans can swap bodies",
    "A city where memories are stored in physical objects",
    "A warrior who fights using illusions instead of weapons",
    "An AI detective solving crimes in a virtual world",
    "A child who discovers they can manipulate time with drawings",
    "A hidden library that contains the future instead of the past",
    "A world where music can alter the laws of physics",
    "A society where dreams are broadcasted publicly",
    "A scientist communicating with plants to prevent disasters",
